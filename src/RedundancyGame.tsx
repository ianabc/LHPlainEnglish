        ...
        {words.map((word, index) => {
          ...
          return (
            <button
              key={`${word}-${index}`}
              type="button"
              className={`word-chip ${stateClass} ${isRevealCorrect ? "word-highlight" : ""}`}
      ...
      <div className="feedback">
        ...
        {isCorrect === true && (
          <div className="feedback-panel success">
            <h2>Nice catch!</h2>
            <p>
              <strong>&ldquo;{currentExample.redundantWord}&rdquo;</strong> is redundant
              here, {currentExample.explanation}.
            </p>
          </div>
        )}
